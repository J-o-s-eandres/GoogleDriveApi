...
├── settings.yaml            # Config OAuth de Google
├── QuickStart.py            # Script de autenticación
...
Para soporte, abre un issue en el repositorio o contacta a [Joseandres Montesino ](mailto:Joseandresmontesino@gmail.com)
